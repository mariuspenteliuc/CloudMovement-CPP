...
// int runExperiments(int CONFIG = 0, string outputPath = "/Volumes/Transfers/") {
// //    FileHelper::writeFile(envPath + "Experiments/day_window_1/test_1/averages/average_wind_map.npy", average);
...
//     outputFolders.push_back(outputPath + "Experiments/Configuration_0");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_1");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_2");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_3");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_4");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_5");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_6");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_7");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_8");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_9");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_10");
//     outputFolders.push_back(outputPath + "Experiments/Configuration_11");

//     vector<string> fileNames;
//     glob(outputPath + "debug_out/flows/*.npy", fileNames, false);
...
//     if (flow.empty()) {
//         flow = OpticalFlowService::averageFlows(outputPath + "debug_out/flows", startIndex[CONFIG], numberOfFlows[CONFIG]);
...
//     } else {
//         Mat blankImage = FileHelper::readFile(outputPath + "Experiments/blank.jpg");
//         Mat grayImage;
...
int main(int argc, const char * argv[]) {
    ...
    const char *envName = "CLOUDS_MOTION_OUTPUT_PATH";
    const char *envPath = getenv(envName);
    // const string outputPath = "/Users/macbookair/Documents/uvt/disertatie/";
    const string outputPath = envPath ? envPath : "/Volumes/Transfers/";
    srand (static_cast <unsigned> (time(0)));

    cout << "Computing optical flow..." << endl;

    OpticalFlowService ofService;
    OpticalFlowService::computeFlowForImages(DEBUG_IN, outputPath + "debug_out/", "jpg", true, true, false, numberOfThreads);
    cv::String pathToFlows(DEBUG_OUT + "/flows");

    cout << "Computing Wind Map..." << endl;
    Mat average = OpticalFlowService::averageFlows(pathToFlows);
    FileHelper::writeFile(outputPath + "/debug_out/flows/averages/average_flow.npy", average);
